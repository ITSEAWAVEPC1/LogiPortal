...
Stages 0, 1, 2 complete, committed, and pushed to `origin/main`. Customer Master v2 (Organization enhancement — Branches/Account Info/Billing/Bank Details/Customize Columns, built on Stage 1's Organization model), Stage 3 (Quotation Module), and Stage 4 (Consignment / Job Creation + Historical Job Import) also complete, not yet committed — see `docs/stage-checklists/customer-master-v2.md`, `docs/stage-checklists/stage-3.md`, `docs/stage-checklists/stage-4.md`. **Next up: Stage 5 (Import Workflow Engine — Ex-Works & FOB tracks).**
